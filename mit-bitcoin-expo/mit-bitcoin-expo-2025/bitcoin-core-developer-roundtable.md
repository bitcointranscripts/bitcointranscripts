...
I'm Cory I have a background in open source, C++ software development, and got tired of putting my credit card number to buy things online. That seems stupid to me.
I read about Bitcoin, the idea that you can push a payment as opposed to pull and that made more sense as it seemed like the way that things should be. So I hoped in. And there's this idea that the code is the money.
...
So we're going to do a nice, easy warm-up here. What should we do about all these soft fork proposal?
