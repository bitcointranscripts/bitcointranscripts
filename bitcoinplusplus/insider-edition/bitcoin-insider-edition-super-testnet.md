...
Woo! Yeah, do you want to explain to the crowd who you are and what you're doing in Austin this week?

Speaker 1: 00:00:09

My name is Super Tesned, I'm a Bitcoin developer.
...
No, I don't think so.
I was really excited that Luke Dasher came to it.
...
I added CTV to it.
So I went through how I, as an illustration of how I code, I had some CTV code and I added it into the test net so you can create CTV transactions.
...
Cool.
Very cool.
So you talked about how Luke Dasher came to your talk and you were excited that he was there.
...
Let's go.
Okay, yeah.
When he was talking to me about the talk, because I really wanted him to do that one, because I thought it was a cool demonstration of what the process is for making that kind of food change, he was telling me that he wasn't sure he could get it to compile in 30 minutes.
...
And at the time, he made this cool poster.
He was like, he updated his mempool policy, and he was like, look, it took five minutes.
...
And then there's, I think, the position that Luke and the Nauts organization, for better or worse, I don't know if you call that.
...
Nazis.
OK, yeah.
The Nauts, they're like, well, we should and we can fight it.
...
I like to fight the spam and try to eliminate as much of it as possible, increase the cost of production of spam and generally just make their make their lives harder so that so that Bitcoin is better money.
...
So, the OpReturn data carrier size limit, should we keep it at 80 bytes, make it smaller, get rid of it.
...
Reduce it to zero.
So you want it such that operaturns don't exist basically.
Remove the operaturn.

Speaker 1: 00:07:24

I think having it so that you can create an operaturn but only if it has zero value.
...
Are they looking through the black data?
...
I'm a fan of sending Bitcoin to each other and not just huddling it.
...
I will be talking on a privacy panel with Seth for Privacy and Andrew Van Weerdum at the Bitcoin conference in Las Vegas.
...
Okay, great.
Well, hopefully we'll see you in Riga then in August, the 7th and 8th right ahead of the Baltic Honey Badger.
...
So types of transactions he did permit were where you're just sending to a Bitcoin address, he allowed you to send just straight to a script pubkey, and he allowed you to send to a multisig which was a list of public keys, and he banned everything else.
...
If a transaction uses operatron to carry a certain amount of bytes, or if it uses an inscription envelope to carry a certain amount of bytes, that's an objective way of telling this is just arbitrary data.
It's not the least amount of bytes necessary in order to accomplish the goal of sending money into an address because you could have done that without including an op return that has data or without including an inscription envelope.
...
How do you balance those two requirements in terms of governance of making the decision to make the filters more strict?
...
And in order to get those activated, there was a bit review process.
...
Okay, yeah.
So we kind of wrapped up the last chat, and at the end of it we said, man, we just talked about, like we wish that at the conference we would have talked about things other than filtering and opportunes and data carriers, and then we spent 20 minutes talking about it ourselves.
...
That makes sense.
I think Rusty had a project in CoreLight and he's trying to add to some of the configurations in route pathfinding so that it would optimize If you're trying to be more private, it would add more hops.
...
Is the cheapest way to send a Bitcoin, a Lightning transaction, wait, Is that the cheapest way to send a Bitcoin transaction is between someone you're directly pierced to on the Lightning Network?
...
You would have been better just doing a non-chain transaction.
...
Decoy public keys.
So one feature of the way lightning invoice, bolt 11 invoices work is that you put a public key in them And if you're running a routing node, then that's enough to find you on the network, to find your node.
...
So I presented my CoinPool software at Bitcoin Plus Plus in Brazil.
...
And so people can find out more about CoinPools by watching your Bitcoin++ talk from Florianopolis.
And you'll be talking about it in Vegas, it sounds like, in a few weeks.
Very cool.

Speaker 1: 00:25:23

Yep, so you can, if you go to YouTube and search for Supertestnet Coin Pools, you should find a video on there.
...
Perhaps I'll be in Riga for the privacy conference there So we'll see what happens, but I'm looking forward to doing those things Continuing to work on random projects that occur to me as they occur.

Speaker 0: 00:26:03

More Bitcoin development coming to you soon from SuperTestNet to yours.
All right.
Thanks, Super.
