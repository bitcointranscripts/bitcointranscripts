...
if I am using my, you know, my Breeze or my Phoenix wallets, which is like, you know, just kind of like not fully custodial, but also not like your own node, It's kind of like in the middle there.
...
Someone else could correct me and then there's more of a long-term gossip B2 where we want to maybe be a little more privacy preserving than that proposal would allow.
...
Because, you know, I have Jeff here who does `LDK`, which is a very fastly growing implementation and is going to have a node soon.
...
So while there are privacy shortcomings of `LNURL`, it's a spotlight on what we need to do to help fix the protocol level with, for instance, `BOLT 12` point paths.
