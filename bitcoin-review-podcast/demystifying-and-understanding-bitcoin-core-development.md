...
Rodolfo Novak: Hello, and welcome to the Bitcoin.Review podcast.
This is an ad-free pod.
Thank you so much for streaming those sats.
If you're a new listener, I'm Rodolfo Novak and I run CoinKite, where we've been helping people secure their bitcoins for over a decade.
We make products like the Coldcard, Blockclock, and we have a bunch of other projects.
...
James O'Beirne: Hi, good to be here.

Rodolfo Novak: Thanks for coming. Sjors.

Sjors Provoost: Hello.

Rodolfo Novak: Thanks for coming back.
And Mike.

Mike Schmidt: Good to see you again.

Rodolfo Novak: Do you guys want to tell the audience what you guys do related to Core?
...
It obfuscated the chain state contents, anything that's loaded into memory, because we were having this problem where Norton Antivirus software on Windows platforms would actually wipe out the chain data because someone had embedded viral signatures in the OP_RETURNS which is pretty funny. Now, we're talking about doing that for blocks, of course with the rise of inscriptions, but I so I since 2018 I've worked full-time on Bitcoin Core and related projects.

Rodolfo Novak: Cool.
Sjors.

Sjors Provoost: Yeah, I've been working on Bitcoin Core since 2017.
I mostly review stuff hanging around in the wallet, but I also like to test completely random stuff and review it. So I've looked at some of James' work and other people.

Rodolfo Novak: Cool, and Mike?

Mike Schmidt: I've never contributed to Bitcoin Core.
...
Rodolfo Novak: And I guess you're being very short there on OpTech, which is an absolutely fantastic resource that I believe started to to try to educate industry on what's going on with Bitcoin Core development, right?
...
You know, people are busy building stuff to ships, to customers.
...
Mike Schmidt: Yeah, I think James could probably provide a bit more of the of the history, but I think it was a suggestion by Adam Back that the communication lines should be opened between developers and Bitcoin businesses.
...
Rodolfo Novak: So I think it's an interesting thread that the reason why I started pulling on from there is because traditionally Bitcoin Core development was sort of opaque because it's like anarchic, right?
...
Sjors Provoost: I mean, the newsletter helps developers keep tab of what's going on.
So,

Rodolfo Novak: It's true.

James O'Beirne: That's true.
...
Sjors Provoost: I read some of the discussion on the on the Bitcoin talk forum for when Satoshi made those changes.
...
Rodolfo Novak: I like to assume there is always private communication.
...
Sjors Provoost: And we know that Satoshi communicated directly with some people because some of the documents were released.

Rodolfo Novak: So, so, okay.
...
James O'Beirne: And maybe I'm sure you so can help me here with the history because I'm a little bit fuzzy, but I think one of the things that he kind of pushed through pretty controversially was pay to script hash.
Is that right?

Rodolfo Novak: Yes, P2SH was.

Sjors Provoost: My understanding that that is true, but I've only read like one long form article about it. I have not actually done any digging myself in that history.

Rodolfo Novak: Yeah, there's also OP_EVAL that had like a recursive bug or something like that.
And it had to be rewinded.

Sjors Provoost: Well, the word eval just scares the hell out of me because like in JavaScript, that's one of the ways you can get any kind of payload to execute in a browser.
So if it was doing anything like that, like just evaluating stuff.

Rodolfo Novak: There was a lot of stuff that was like, it could be seen as either incompetence or sketchy.
...
Sjors Provoost: Yeah, in the beginning, I'm guessing it was more like a normal open source project

Rodolfo Novak: Right

Sjors Provoost: And it started evolving to the point where developers realized they can't just unilaterally change things.

## Modern Bitcoin development

Rodolfo Novak: So let's then evolve to the point where, you know, like post Gavin era where, you know, he was still trying to split Bitcoin Core from the wallet and all that stuff.
...
There's a lot of money in the system And all it's like sort of like less sketchy quote unquote kind of thing.
...
Sjors Provoost: Well, you, I mean, so that's important to distinguish.
...
Then on your own computer, you get some sort of code editor or for README just some sort of notepad, I guess.
...
James O'Beirne: But I think let me, yeah, let me pick up on that part of the story, because I think this is where Bitcoin gets very, very interesting and diverges from a lot of other, say, application development.
...
Rodolfo Novak: But why is that?

James O'Beirne: Yeah, I mean, it's very, very important because the idea is, aside from, you know, any kind of like deployment complexity that some kind of auto push thing would introduce.
...
Rodolfo Novak: Well, let's just give an example, right?
...
Sjors Provoost: But to go on that, into that rabbit hole, I think there was a way on Ubuntu to install a Bitcoin Core through the apt repository.
...
Sjors Provoost: And so you can wait to see if there's a panic on Twitter.
And if so, maybe wait a little bit.

Rodolfo Novak: And also like and then there is the keys, right?
...
Sjors Provoost: Yeah, though you have to sort of distinguish what exactly a Git signature means, so, or Gideon in the old days.
...
Like I've git signed Knox, Knots, Luke Dash's version of Bitcoin Core.
...
Rodolfo Novak: You know, It's kind of like a retweet, you know, like just because you retweet something doesn't mean you agree with it.

Sjors Provoost: Well, but it's somewhat implies it.
...
James O'Beirne: But so that's, you know, this Wall Street Journal article that just came out last week called something like, oh, the six shadowy coders that control Bitcoin or whatever.

Sjors Provoost: The title was terrible.
The contents wasn't too bad, but they do miss the point.

James O'Beirne: Yeah, I just, yeah, I think it's gonna be probably interpreted by the laymen in the wrong way because what would happen, like, let's say hypothetically, tomorrow, one of the maintainers doubled the block subsidy, right?
...
Rodolfo Novak: But there is one more thing here, right?
...
Sjors Provoost: Well, but let's say they did it carefully and they just did a block size doubling.
...
Rodolfo Novak: I mean, you know, a great source of security for Bitcoin is for people to run old nodes and run many versions of Bitcoin.
That backwards compatibility that we have in Bitcoin is something very special in my view.

Sjors Provoost: Shima's pointed to forkmonitor.info, which does that.

Mike Schmidt: I think the BitMEX folks run a bunch of those including older Bitcoin Core, as well as some of the other implementations like the Bitcoin or BTCD.

Sjors Provoost: Yeah, I built that.
So basically, but it's for BitMEX Research App.
So it runs a bunch of older nodes.
It also runs different implementations.
It used to run the Libbitcoin, but it became quite hard to run it.
...
Rodolfo Novak: Well, I mean, and now people are going to want to probably increase their mempool size so that the dickbutts fit.
...
Sjors Provoost: Well, a state actor is more than welcome to make a pull request, but then it'll be the state actor that has to hire, I guess, people who work for state actors to write code.
...
Rodolfo Novak: But realistically speaking, right?


Sjors Provoost: So anybody who wants to change will have to do it themselves or hire somebody to do it for them.
...
Rodolfo Novak: You get used to rebase.

Mike Schmidt: Well, this is like the change the code.

James O'Beirne: Oh yeah, yeah, that's a good one.

Mike Schmidt: Change the code initiative, right?
Still waiting for that PR.

Sjors Provoost: Yeah, That's an example of how you're not supposed to do it.
...
Rodolfo Novak: But that's their intent, right?
Their intent is just to cause confusion and, you know, orchestra style.

Sjors Provoost: Well, it depends on what you mean by they, right?
...
Rodolfo Novak: But you know, we saw sort of like interesting kind of like, I want to call it like time wasting, dramatic, completely irrelevant changes, like when they changed the term blacklist, right?
...
I may not be a coder.
I want, I want this amazing thing done and I'm willing to fund it.
How would that, how would people go about that?

James O'Beirne: Yeah, I mean, this is another one of the ways that Bitcoin is really unique and unlike any other open source project or even software project in that there's really no, there's no roadmap.
...
Rodolfo Novak: I mean, you gotta rebase, right?
...
James O'Beirne: In an mergible state, yeah.

Rodolfo Novak: Exactly, right?
Because that might be your chance of the year, right?
Yeah.
Sjors.

Sjors Provoost: I was going to say, but then you do rebase.
And then once in a while, somebody comes by and says, Hey, don't rebase this stuff.
I want to be able to run it on top of an older branch of Bitcoin core.
That's happened to me a few times, not very often and usually by one person.

Mike Schmidt: There's a few different things that are in play there.
Of course, we talked about anybody, you know, Sjors walked through how you could open up a PR and update the readme and potentially you find an issue that you'd like to work on and you can work on that.
...
Rodolfo Novak: You know, I personally have no issues if you guys wanted to sort of like dictate what do you want to see exist?
...
Mike Schmidt: Yeah, I think there's there's an implicit or explicit direction.
...
Rodolfo Novak: You know, I think it's important for people to like not be shy about airing their business intentions.
...
Sjors Provoost: I suspect that there's not a lot of companies that have a very specific thing that they want to change in Bitcoin Core that would warrant finding, recruiting a full-time developer.
...
Rodolfo Novak: I'll give you some examples For example think about like you know Lightning Labs and all the Lightning Network people, they needed Maleability to be fixed and some of the features of SegWit in order to exist.
...
Sjors Provoost: But Stratum V2 you can see the other approach which is just build your own software project because Stratum V2 in principle is its own software project now

Mike Schmidt: Right

Sjors Provoost: At some point there may be some things that they'll need a tweak to Bitcoin Core for in order to make it work.

Rodolfo Novak: That's often how it is, right?
Like the business will have this thing, but then they need a few little tweaks to Bitcoin so that like their thing actually works in a sort of like performant way,

James O'Beirne: right?
And I mean, you could imagine that in many cases, a business might make those tweaks and they might just run a patched version of Bitcoin D.
...
Sjors Provoost: The Segwit2x thing was interesting to watch that, because there were attempts to increase the block size, like smaller pull requests, by experienced developers like Gavin.
...
Rodolfo Novak: yeah, so that's sort of like leads me to sort of like the next thing, which is

## Who chooses what gets merged?
like who chooses what gets merged and how does something gets actually merged because You know if one thing I think a lot of people already understand is that like changes are excruciatingly reviewed, right?
Even minute changes.
...
James O'Beirne: It's a really subtle and difficult thing to explain because on the one hand, the line that we all like to recite is that maintainers are just janitors and really They act as a kind of conduit to express the broader desires of the technical community.
...
Rodolfo Novak: so- The proverbial gray beards.

James O'Beirne: Yeah, the gray beards, exactly.
...
Sjors Provoost: But to get to the question of what should happen in kind of in theory, I guess, and I think it happens mostly in practice too, is there is a bunch of people who review code and then there is a group of about five or six whitelisted people essentially that we call maintainers who can hit the merge button on GitHub.
...
Rodolfo Novak: It could have been somebody else.

Sjors Provoost: Maybe I can hit the merge button, I don't know.

Rodolfo Novak: I mean, provided it was not signed, right?
Technically they could download, they could merge it locally, sign it, and then push it back.

Sjors Provoost: So there's a group of people that are listed in a text file by their PGP key.
...
Then you have to check, I guess, spot check or trust or whatever you want, that they are following a process that when they merge something, you can go back and see what they merged, and you can look at the pull request and see the discussion.
...
Rodolfo Novak: that goes sort of like back to this, right?
...
Sjors Provoost: Well, and also you're running, lots of people will run not the releases, but the master branch, so the in-progress version.
...
So like, you're going to have literally cold line comments, right?
...
Sjors Provoost: That's pretty rare, though.
I would say the amount of pull requests that have overlap with what happens on the mailing list is probably 1%.
But those are

Rodolfo Novak: the ones that are the biggies.

Sjors Provoost: Well, yeah, because they might influence some sort of either consensus or at least at the peer to peer level.

Rodolfo Novak: Full RBF, right?
...
Sjors Provoost: It's not how you submit your inscription.
...
James O'Beirne: BIPs are, I guess, like a very technical specification of some idea that's relevant to Bitcoin.
...
Rodolfo Novak: So Like, you know, would you say like, maybe people like, I just saw this sort of like slight drama with the Ordinal's BIP being introduced.
Right.
...
James O'Beirne: I guess the counterpoint would be that, you know, and I don't know how I feel about the ordinals, but it's probably fine to add.
...
Sjors Provoost: But I wouldn't put too much value on whether something gets a BIP number, right?
...
Rodolfo Novak: So I think the original sin of BIPS is not having a stricter sort of like a set of requirements that you have to meet in order to make it as a BIP.
...
Sjors Provoost: Well, there's a lot missing, right?
...
Mike Schmidt: tonal it's in tonal

Sjors Provoost: that could be so the taproot bips you know or 340 341 342 but there's a lots of unused numbers there so

Mike Schmidt: Rodolfo are you saying that you think the BIP repo is too liberal on letting things in?
Is that your point?

Rodolfo Novak: I think so.
...
Sjors Provoost: I think BIP2 actually put some constraints and like it has to have some technical merit.

Rodolfo Novak: But those should be drafts.
...
Sjors Provoost: I think you're prematurely optimizing it.
...
Sjors Provoost: So- So they just write a proposal and don't give it a number and put it on the mailing list.
...
Sjors Provoost: But you get the best responses once you've actually implemented something like working code, either in Bitcoin Core or somewhere else, depending on what the thing is that you're working on, then you'll get feedback from the relevant people.
If you're just writing a sort of a high level proposal, yeah, then you're gonna

Rodolfo Novak: get- No, it doesn't belong in a BIP.
...
Sjors Provoost: But if you're putting something on the mailing list that's not very fleshed out, then the people who are going to respond to that are the people who are into things that are not very fleshed out

Rodolfo Novak: Right.

Sjors Provoost: Most will either ignore you because they'll be tired of even pointing out that your proposal is not fleshed out enough.

Rodolfo Novak: So my idea is, you know, like have a slightly better improved set of rules and then just dump them in a separate repo, right?
...
Sjors Provoost: I don't want to see it as long winding discussion about meta, what has to go in a BIP or not.
And you just you don't want this.

James O'Beirne: Yeah, when I was doing a ASSUMEUTXO, I didn't do a BIP for that.
...
Sjors Provoost: I would say ASSUMEUTXO definitely deserves a BIP if somebody else because it's not something that should only work in Bitcoin Core.
And, you know, you might want to build tooling around it, too.
So

Rodolfo Novak: just selfishly speaking, like I don't want to go read the discussion first.

Sjors Provoost: Right.

Rodolfo Novak: I want to go read the paper first.
Right.
...
Rodolfo Novak: only problem

Sjors Provoost: is, the only problem is if you go to the PDF, that's from like early January.
...
Rodolfo Novak: Personally, I don't like PDFs. Yeah, no, screw PDFs, Markdown.

Sjors Provoost: It's all written, I assume it's written in Markdown and then you generate the PDF.
So you can read the original Markdown.
My point is that-

James O'Beirne: No, I wrote it in LaTeX.

Sjors Provoost: No. Oh, but you can write with Pandoc.
You can write Markdown, which is converted to LaTeX and then write- Yeah,

James O'Beirne: but the formatting isn't as nice.
You don't get as much control.
I wanted to make a nice looking paper.

Sjors Provoost: Pandoc is extremely powerful.
I would not underestimate it.

Rodolfo Novak: Do the PDF once it goes in.

Sjors Provoost: I spent a ridiculous amount of time fiddling with the layout of my book, like figuring out how to get Pandoc to do certain things.
That's true.
But anyway, it's nice to have like a high level document, like a pretty PDF and then a bip and then you know, you can see the mailing list discussion.
But yeah, anyway,

Mike Schmidt: And there's actually versioning new venue that you want your idea or your code to get in.
...
James O'Beirne: Yeah, I think so because it used to be if you wanted to play with a pending soft fork, you had to wait until that soft fork got enough consensus to go to TestNet, and then you could do TestNet transactions.
...
Sjors Provoost: But does Inquisition run on the regular SIGNET?

James O'Beirne: Yeah.

Sjors Provoost Because in principle, you can have a custom SIGNET for every single software proposal.

James O'Beirne: Yeah.

Sjors Provoost: I guess it's nice to have a lot of sample transactions in a real blockchain and faucets and infrastructure like that ready to go.

James O'Beirne: Yeah, and I think the idea is to sort of measure how any given proposal interacts with totally unrelated stuff, you know, so you would want some unrelated traffic.

Sjors Provoost: So Inquisition combines all the code then?
It's like, takes all these pull requests and adds them together.
That's pretty cool.

James O'Beirne: Yeah, and it's kind of a pain because now I have two things to rebase whenever anything changes.
...
Mike Schmidt: So you can actually have OpCTV.

James O'Beirne: Yeah, right.
Right now he's merged APO, CTV, and hopefully pretty soon Vault.

Rodolfo Novak: Very cool.
...
Sjors Provoost: This is, it is a bit strange though, because the idea of testnet was to just test things, but typically when you wanna do something on testnet, it should be probably be merged into Bitcoin Core, even if it's only active on test net.
And here, I mean, Signet should be no different in principle because Signet is just the same as testnet in that sense.
But now what you're doing is you're taking a different repository and you're merging these experimental softforks in there, and then the consensus is enforced by the people who run that particular SIGNET, which in this case is two people.
I guess it works.
...
Sjors Provoost: It's a risk, yes.

Rodolfo Novak: It's a realistic risk.

Sjors Provoost: Well, it depends on the risk for what, but it's, it's such a useful tool that if we get rid of it, yeah, it'll be a bit safer, but we'll move about 10 times slower.

Rodolfo Novak: We see like people tend to think that like, you know, we are at risk, right?
...
Sjors Provoost: Let's say GitHub could just change the code from under us, but that's why we have all these signatures, so that's pretty easy to detect and make a bunch of noise about.
...
Mike Schmidt: There's also, like, the TornadoCash example, where they just decided to take down the repository completely.
...
Rodolfo Novak: like, you

Mike Schmidt: know, emoji reactions, you know, up down vote, you know, those sorts of things maybe don't have a mapping.
...
Rodolfo Novak: It's the metadata and the logic that GitHub have that's quite good.
...
Sjors Provoost: Yeah, I think this general sentiment is that GitHub is good as long as it's there, but we should always assume that it may disappear from one moment to the other.
...
Rodolfo Novak: You know, I always joked about, what's the name of that Adobe competition on Linux?
I keep on saying to them, don't try to invent something, you just copy Photoshop, please.

James O'Beirne: Oh, gimp.

Rodolfo Novak: Yeah, so like, please just keep all the buttons exactly the same.

Sjors Provoost: But a lot of the other scenarios that people would be worried about by thinking GitHub is centralized, like yeah, GitHub itself could start messing with the code.
...
Rodolfo Novak: Well, even more, right?
...
Sjors Provoost: Yeah, and if it's just like one core dev who happens to run a little server, then he gets compromised.
...
Rodolfo Novak: I think the biggest risk with Git, like realistic practical risk is like, for example, say China tells GitHub, don't show the Bitcoin repo to Chinese people.
...
Sjors Provoost: could be an argument for having a good mirror somewhere so that people can keep contributing on some other website.
...
Rodolfo Novak: So guys like, you know, to, to, to go into a more difficult topic here.
...
I really don't like the speedy trial stuff, you know, LOT=true, you know, so, so like, as default, so those are my sort of things, but like, how do you feel about this from more like, yeah.

James O'Beirne: Yeah, Rodolfo, can you, can you describe what you don't like about speedy trial, because from what I know, all speedy trial is saying is basically like, hey, we're gonna do a short period where if all the miners absolutely want this thing, then they signal.
...
Rodolfo Novak: So I don't wanna give miners an upper hand in the dynamic, right?
...
Sjors Provoost: then you don't like the whole idea of using miners to activate softworks.
...
Rodolfo Novak: But then let's make LOT=true.
Yeah.

Sjors Provoost:  As soon as you start adding game of chicken dynamics that can potentially lead to giant re-orgs, you have removed the whole safety.
So if you don't care about safety, then why are you trying to do it safely?

Rodolfo Novak: No, it's not black and white.
Hang on.
...
Sjors Provoost: Well, the idea of Speedy Trial was to try it before anything else.
So something like LOT=true could have been done after the Speedy trial.
...
Rodolfo Novak: I want people to like shit or get off the pot, right?
...
Sjors Provoost: Well, that's why I don't like this speedy trial either because I think it would have been fine to just do the regular bip 9 activation

Rodolfo Novak: Yeah, that's fine by me

Sjors Provoost: And maybe we could have modified it to the BIP 8 without the LOT=false stuff because it uses heights.
...
Sjors Provoost: So I think we shouldn't have made a fuzz about it and it's very easy to deploy multiple soft forks at the same time using BIP9.
...
Rodolfo Novak: I don't think you can have multiple things going at the same time.

Sjors Provoost: You have some, you have a controversial soft fork number one and another one number two, and then one of them caused a time bomb, but the other one activated, but then due to a giant reorg, the other one didn't activate.
I don't want to think about it.

Rodolfo Novak: So here's an interesting thing.
...
Sjors Provoost: But I don't know if it could have been done that much smaller.
...
Sjors Provoost: I mean, you could have done like Schnorr separately and other things separately.

Rodolfo Novak: I don't know.
...
James O'Beirne: All I can say is, you know, when I started doing assume UTXO and obviously like implementation changes are different from consensus, but I had this very optimistic idea that I would carve this thing up into a bunch of tiny changes and do it bit by bit so that everybody could follow along and be assured that every step of it was safe.
...
Rodolfo Novak: You know, it's funny.
...
Sjors Provoost: I mean, old nodes, it's anyone can spend.
So, you know,

Rodolfo Novak: it's fine.
...
Mike Schmidt: Activation.


James O'Beirne: I thought it was hilarious.
...
Rodolfo Novak: No, I mean, I was angry about the activation.
...
Sjors Provoost: Not that independent though.
...
Rodolfo Novak: I understand, but like, you know, we have proofs for it.
...
Sjors Provoost: Well, the shoved through part is you could say the speedy trial kind of gives that feeling perhaps, but I think if there had been no drama, the BIP-9 deployment would have been earlier than that we had speedy trial.
...
Mike Schmidt: Well, it's a bit interesting that, you know, we had the, so some folks from Optech and AJ Towns put together taproot review and there was little groups that met each week or every two weeks and sort of went through different prompts and tried to review this, the code base, the package, as you say, Rodolfo.
...
It's a little disheartening that so much energy and passion went into that where it felt like people were kind of going through the motions and actually reviewing the thing.
So there's a bit of contrast there that I wanted to point out.

Sjors Provoost: I'm glad that people did do all that intensive review of the package, which I went to one of those workshops in London.
It was

Rodolfo Novak: really great.
I mean, like it was it was incredible.

Sjors Provoost: That was really good.
...
James O'Beirne: It's a bug shed.

Mike Schmidt: Yeah, exactly.
I

Rodolfo Novak: think you guys are sort of like looking at this more from the core perspective.
...
Rodolfo Novak: Oh, yeah, the drama is regarded.


Sjors Provoost: If the drama is about the content of the thing, that's the kind of scrutiny you want.
...
Rodolfo Novak: But you know, you could say that the activation method still unsettled, right?
...
Sjors Provoost: I mean, my heartache on the Activation is just BIP-8 minus a lot of true stuff, and it's fine.

James O'Beirne: I think that's the thing, is like if there was some fundamental objection to TAPROOT people had, they could have articulated it through Speedy Trial.
...
Probably somebody like, you know, with the Inelective Shores, should be thinking about that stuff.
I don't have the mind for it, but, but yeah, I just think if there were...


Rodolfo Novak: I don't want to do it either.
That's why

Sjors Provoost: I just do BIP8 without a lot of true stuff.
Because I've already reviewed that code.
So

James O'Beirne: that's fine.
Right, right.

Rodolfo Novak: And, you know, like, guys, I don't I don't think like there's no amount of discussing it at least at this stage of Bitcoin that I think will make it easier.
...
Mike Schmidt: Do we need something easy?
Do we need to do the great consensus cleanup?

Rodolfo Novak: I think that if we found a way to have miners have a backseat on it and yet like they still have to participate because they still have to activate, right?
...
Sjors Provoost: But I don't know what you would demonstrate then that's always the problem there.

Rodolfo Novak: No, I know, that's what I'm saying, I don't have an answer.

Sjors Provoost: So if you want to have a fun one, I guess the great consensus cleanup could be an interesting one to get some complicated game theory because one of the things it does is it diffuses the time warp bomb or the time warp thing.
...
Rodolfo Novak: I'm just saying, like, if anything, it would just be fun to watch.
...
Sjors Provoost: thing you're worried about?
Or is there ever a scenario where you're worried about the miners stopping the change from going through?

Rodolfo Novak: No, I'm not concerned about the miner stopping changes because aside from like...

Sjors Provoost: That's not as true, right?
...
I'm not as concerned about them blocking because, you know, the only thing they would want to block is like you know say I'll go change right but then you're already ignoring them anyways right like anything that they would truly want to block or things that like you just be moving on from them anyways So I don't think that that's a concern.

Sjors Provoost: I don't think we have a mechanism to stop miners from activating a soft fork that we don't have.

Rodolfo Novak: Oh yeah, no, I agree.


Sjors Provoost: And we've been waiting for a very long time for some other group of miners to re-org them.
...
Rodolfo Novak: Yeah, but then you add more fee and some other miners gonna mine it, right?
...
Sjors Provoost: Well, that is a case where the just having miners enforces soft fork doesn't really make it a soft fork because the economic nodes will completely ignore that rule set.
Nobody will run a node that enforces that rule set.
So as soon as the majority of miners no longer enforces it, no longer reorgs out blocks that don't comply with it, then you just get it.
...
Rodolfo Novak: Now another fun thing too on that game theory is that like, you know, as Bitcoin halves, right, the rewards per block, like, you know, the miners further depend on the users, right.
For their income.
...
Rodolfo Novak: So sure.
But then, you know, we're going to have an empty block every four.
Who cares?
Like, I mean, it's not the end of the world.
It's going to suck.

Sjors Provoost: No, they'll get subsidized to reorg, basically.
So basically, the miner revenue is not from coming from Bitcoin transactions is coming from governments that pay them to censor.

Mike Schmidt: This is the Eric Boskewil discussion.

Rodolfo Novak: Yes, very much.
...
Sjors Provoost: Yeah, it'll be an interesting question about security budget, like who has the bigger budget here?
...
Rodolfo Novak: You know, a heuristic that I like on that, It's not like a perfect analogous to it, but it's like Bitcoin is the largest computational capacity on earth by like many, many, many, many, many orders of magnitude.
...
Sjors Provoost: Like, is it really though?
I mean, I know we have a lot of hash power, but I think, I don't know how it compares to other data centers.

James O'Beirne: It's not like general purpose compute, right?

Rodolfo Novak: It's not general purpose, but it is.

Sjors Provoost: No, no, I get that.
We're the biggest SHA-256 thing in the world, but we're not necessarily the biggest compute thing in the world.

Rodolfo Novak: I think it is.
Like somebody did some calculation on that, right?
And it was a crazy amount.
I mean, ours is specific.

Sjors Provoost: I have no idea how many gigawatts worth of data centers is out there that are just doing general compute and AI.
Maybe Bitcoin is bigger than that, but maybe not.

Rodolfo Novak: That came up, I think on the last, sorry, on the previous bull run.
...
Sjors Provoost: Well, to the first one, so The problem I guess is we have lots of good views into what's going on if you read Optech, but the average Wall Street Journal reader is not gonna read Optech.
...
Rodolfo Novak: Well, I mean, the cool thing about pop science is that it can just invent whatever the fuck you want.
...
Sjors Provoost: So the risk comes in.
Right.
...
James O'Beirne: Yeah, I think, you know, the Wall Street Journal has political motivations.
...
Mike Schmidt: I actually spoke with the author of that article before the article, And it wasn't clear what he was going to be writing about.
...
Rodolfo Novak: You know, one little tip on media relations is when a reporter reaches out to you without being very clear on the article that he's writing, like, oh, I'm writing this.
...
Sjors Provoost: Well, the problem is it's hard to distinguish from actual good journalism because an actual good journalist writing an honest piece, which may or may not be critical, would also not tell you what they're going to write because that's their job.
...
James O'Beirne: But they're not gonna be breaking that news.
It's, you know, someone in the technical community is going to figure that out well before they would ever, you know, you

Rodolfo Novak: know, I found like 99, 99% of the time when they reach out with like, you know, they, they will be very specific when they're in good faith.
...
Like they're very forthcoming of what they're writing when they're not being insidious.
Right.
Like, And when they're like doing a hit piece or something negative, they always hide what they're trying to write.

Sjors Provoost: Yeah, there's a bit of observation bias in there because all the pieces that are mainstream pieces about Bitcoin have been negative hit pieces.
So like It's very hard that you would have been approached by an honest piece.

Rodolfo Novak: No, there has been.
...
Sjors Provoost: Well, the first person we need to, you know, as a group of people need to convince how the process actually works is, you know, a certain judge in England.
So that'll probably give us a lot of ways to phrase things that they understand.

James O'Beirne: You know, again, see political motivation.
...
Sjors Provoost: Yeah, I'm not saying we should use those institutions to communicate these things.
...
Rodolfo Novak: But here's the thing, right?
...
Sjors Provoost: it, right.

Rodolfo Novak: There's going to be some of de-factors from them, but like the majority of the damages, listen, we're coming for your, for your bread.


Sjors Provoost: If you're trying to reach large audiences, you don't need to go through traditional media, but I would call Joe Rogan mainstream media at this point.
Like he's reaching a bigger audience.
He doesn't get Bitcoin.
No, but you can go on his show and basically talk.
So

Rodolfo Novak: people have tried.

James O'Beirne: Yeah, you guys are 100% right.
...
Mike Schmidt: There's some room for improvement even within our own house.
I've noticed this.
...
James O'Beirne: Oh yeah, that moron Steve.

Mike Schmidt: Yeah, well, there's that, but there's him and then there's others too.
...
Rodolfo Novak: But I think that's what happens when people who are not software people,

James O'Beirne: right?

Rodolfo Novak: Look at Bitcoin.
...
Rodolfo Novak: I mean, like, and these are people who go on spaces and talk about like Bitcoin as if they were some expert.

James O'Beirne: I was just going to say real quick and, you know, I'm sure Sjors And Mike, maybe this resonates with you to some extent.
...
Rodolfo Novak: You know, and, and, you know, people want to get paid to work.
Like, I mean, that's.

James O'Beirne: It takes four years of full-time context, at least for me.
...
Rodolfo Novak: Are out of ignorance and frustration.
Right.
...
Right.
So the answer is, listen, stop fucking with my money.
Right.
...
James O'Beirne: Emotionally, that's a completely fair stance.
Yeah.

Rodolfo Novak: But the market might not agree with them.

Mike Schmidt: You need a 25.0 release of Bitcoin at some point.
...
Rodolfo Novak: No, but for example, you know, it would be very easy to sell stuff like, for example, encrypted communication between nodes with a white listing.
Right.
...
Right.
Like there is things that you can do because those things don't feel like you're amassing people's money.
Right.
Even though you are creating slightly different dynamics in a way.
So like, you know, there is a narrative, a narrative issue.

Sjors Provoost: I think that's not for those people.
...
James O'Beirne: Well you need a Windows computer, right?

Sjors Provoost: Yeah, for one thing you need a Windows computer, but try to run old Windows software I think it will refuse to run it because it I think it used to let you run in like 32-bit mode and it might not do that anymore.
...
Rodolfo Novak: But that's because people are not running FreeBSD because if they were running FreeBSD like us, they would have servers, they have like six years of time, you know, running an old core on it and everything is just fine.
Don't touch it.
That's what's working.

Sjors Provoost: That's what's working.
...
Rodolfo Novak: I'm just kidding.
...
Sjors Provoost: But I also think protocol is not done yet in the sense that it's not going to be able to handle.
...
Rodolfo Novak: You know, recently after the whole drama with ordinals, right, I think I was talking to Rindell And I sort of like kind of came to this realization just talking that like, okay, so it's 5,000 years have passed, right?
Like there is not a single person that has been able to verify from Genesis anymore.

Sjors Provoost: Yeah, I think that will happen eventually.

Rodolfo Novak: And no, but it gets extra interesting, right?
...
Sjors Provoost: And there will be coins that people will allege are like unfairly created.
...
Sjors Provoost: Well, people have an ideal picture of what Bitcoin should be.
...
Rodolfo Novak: Maybe just separating more of the consensus stuff from operational business logic stuff might help a lot.
...
James O'Beirne: I get what you mean.
...
Sjors Provoost: But so far it's just one giant blob of code and it is being organized better, but I think no matter how you do it, you also want to clean up the code in that giant blob or even in the consensus part of, however you want to define that, Even if we have a separate kernel, you know, that's being worked on, that kernel itself will have C++ code that we'll want to make maybe safer so it doesn't crash or so that it still compiles or so that it validates signatures three times faster.
...
Rodolfo Novak: Can you imagine if that was done inside core?
...
Rodolfo Novak: I don't think there is more than 10 people in the world that can.

Sjors Provoost: I feel good when I see the test suite didn't change.
Then If the right test factors are there, it's probably not malicious.
But good luck reviewing that.

Rodolfo Novak: No, but like that's the thing, right?
...
Sjors Provoost: Not just the grey beards.
I mean, you can also, you will use the new version.
You will sync the Bitcoin core blockchain from scratch with the Zoom valid off

Rodolfo Novak: and

Sjors Provoost: a bunch of things like that.
...
Rodolfo Novak: Hey guys, we're hitting two hours here.
...
Rodolfo Novak: There might be, I haven't read them yet.
So a heads up there.

James O'Beirne: Oh, Nostr only.

Rodolfo Novak: So, okay.
...
Sjors Provoost: be working in your own little corner and you have no idea what's happening in other.

Rodolfo Novak: I think it's two things.
...
James O'Beirne: Well, Optech, like you said, does a really good job of surveying everything.
And I just think...


Sjors Provoost: And also reads the mailing list for you.

James O'Beirne: Yeah.
Yeah.

Sjors Provoost: That's very nice.

James O'Beirne: It's just a lot of work.
...
Rodolfo Novak: And you don't know what's going to stick or get abandoned for a while either.
It's like

Sjors Provoost: you don't

Rodolfo Novak: want to invest too much effort into stuff that could just sort of sit there forever.

James O'Beirne: Yeah, I mean, Peer's Bitcoin Axe thing was pretty cool.

Rodolfo Novak: Yeah.
What was, and you could put bounties, right, on PRs too.

James O'Beirne: It didn't really work though.
Like the bounties never really worked.
I think you could kind of.

Mike Schmidt: There's a couple of different layers.
...
Rodolfo Novak: I normally don't have time to go through the whole Optech.
Like it's like because it's just there's too much stuff going on in Bitcoin.

Sjors Provoost: And you guys are really curate.

Rodolfo Novak: No, and you guys are really curate all that stuff into even last.
Right.
...
Mike Schmidt: You want it longer.

Rodolfo Novak: Yes.
I mean, there's no topic in Bitcoin that it can do in less than two hours.
This was something that one of the reasons why I started this pod is because you cannot have any Bitcoin conversation in less than two hours.
...
Sjors Provoost: I know another podcast.
Sorry?
...
Rodolfo Novak: But you know like, but your pod is like, is very good for like average people to try to understand Bitcoin, but it's not like addressing like specific like issues that are timely or is it like.

Sjors Provoost: Yeah it's mostly actually we try to be evergreen.
...
Rodolfo Novak: That's what people do by the way.

Sjors Provoost: Yeah and The thing is most of these episodes are still correct.
...
Rodolfo Novak: But I am a listener.

Sjors Provoost: Thank you.

Rodolfo Novak: Right.
Okay.
All right.
So, so let's move on to the next question here.
Current FUD from MSM about small number of devs that we've already addressed that one that was from 1F5 to be.

Sjors Provoost: Well, we didn't address the part that they confused developers and maintainers.
They really just suggested there was like six developers, even though there are more than a hundred.

Rodolfo Novak: No, but I don't think we can address that.
That's just stupid.
...
Sjors Provoost: I've heard a little thread on Mastodon basically pointing out some of the errors in the article, including I think that one.
Anyway.
Yeah.
We've addressed it.
...
Sjors Provoost: We also have this thing called the whistleblowing effect.
...
Sjors Provoost: And there's a book about the blockchain wars, right?
Called The Blockchain Wars.
The Block Size Wars, Jonathan Beer.

Rodolfo Novak: Johnny.
Yeah.
BTC Totoro.
...
Sjors Provoost: It's basically like any job where you're working from home except you don't have direct colleagues in the same way you don't have a boss that's screaming at you, and so you have no idea what you should be working on?
No, it's not, I don't know, it's not always easy.

James O'Beirne: No, I find it exceptionally difficult at points, especially if you're kind of in the middle of working on something that's not, you know, getting a lot of review or you're unsure about how to proceed on something or, you know, you're kind of you spend a lot of time trying to figure out what's worth working on.
...
Sjors Provoost: Well, one thing that's peculiar about, I guess, Bitcoin Core as a team or to the degree that it's a team, there's no office.
...
Rodolfo Novak: It's also very academic too.

James O'Beirne: It's very academic.
Yeah.

Rodolfo Novak: It's, You know, like you have to have a, like a threshold of, of like pain that's very high, at least in my view, I don't exist in academic environments.
...
James O'Beirne: I tell people it's like doing a PhD except you don't have an advisor.
Like you're just on your own, you know, hoping you're doing something useful.

Sjors Provoost: Well, worse than that, I think, because there's no scope.
...
Rodolfo Novak: But there's perverse incentives there.
...
Sjors Provoost: I'm doing that so that I get on your podcast.
...
James O'Beirne: I have like five of those to do list systems and I keep making them and abandoning them.
Like I have, you know, like five different lists with PR numbers on them to review.

Rodolfo Novak: You know, I do not do to do lists.
Fuck to do lists.
Fuck calendars.
No. You said you do.

James O'Beirne: No calendars.
That's no.
Wow.
That's barbaric.
I don't know.

Rodolfo Novak: You know, like, listen, you know, like I have some bare calendars, like for example, Johnny would put the episodes to do, or, you know, I have a call with a lawyer, but I don't schedule a single anything unless it's like, you know, trying to get a group of people to do a very specific for anything more than two days.
...
Rodolfo Novak: I remember that one.

Sjors Provoost: And it really does the job.
...
Rodolfo Novak: Yeah, no, I can't deal with that.
...
Sjors Provoost: I'll toss everything in the system that needs to be done, but sometimes, but usually when I'm doing things, I'm just doing them based on notifications or what I feel like.
...
Rodolfo Novak: You know, unimportant items, just it's like, it's like noise pollution in things to do.
They just like deviate you from like the things that are actually important shit gets done.
Yeah.

Sjors Provoost: But not when you're reviewing,

Rodolfo Novak: you know, like it just because it needs to happen like taxes or like, you know, shipping, whatever.
...
Sjors Provoost: No, but if you look at like, you know, in GTD you have things, something called a project, which is anything that's more than one action.
...
Mike Schmidt: The Eisenhower matrix, right?
...
Sjors Provoost: Just get shit out of the way.
...
Rodolfo Novak: Maybe we should do an episode on just that time management.

James O'Beirne: I'd like that.


Sjors Provoost: It just works better.
...
Rodolfo Novak: Yeah, I think like people just struggle with like actually triaging what is actually important.
...
James O'Beirne: And that's very important.

Rodolfo Novak: Be stupid.
...
Sjors Provoost: Yeah, you don't have to be busy all the time, all the day basically.
That's

Rodolfo Novak: horrible.
Anyways, all right.
...
Rodolfo Novak: No, but C is like, if you can do C, the world is your oyster.
It's like, it's a different thing, right?
You understand computers now.

Mike Schmidt: I think the philosophy is important too.
...
Sjors Provoost: Yeah, and if you wanna do Testing, you don't actually have to understand either of these languages, at least not in detail.
What is much more useful for testing is understanding how Bitcoin Core should behave.
A lot of what I do with video is just like, I'll see somebody change something and I know how it should behave and I'm going to try and guess what they forgot and then see if I can break it very quickly and then just say okay you broke this part and then move on to the next bulk.
...
Rodolfo Novak: This reinforces this idea that like, you know, and why you need to have full time people on it is because it takes like, you know, like nearly a decade for somebody to have full visibility on the code base.
Right.
Like, like a good sort of like broad view on what's going on.
Right.

Sjors Provoost: You will never have full visibility on the code.
...
Sjors Provoost: I don't think you need to do it full time, by the way, but I'm very Dutch in that sense.
...
Sjors Provoost: And there's a developer notes markdown file in the GitHub repository that has a bunch of these standard things like, you know, do the intendation this way, do the intendation that way.
...
James O'Beirne: The document that Mike referenced earlier, the onboarding to Bitcoin Core, I think spends a lot of time talking about architecture and the considerations that would involve and how the evolution of how things have gone.
...
Sjors Provoost: Yeah, but usually if you're making a small change, you're not changing the structure that much.
...
Rodolfo Novak: Okay, so Bourbonicplague, would love to hear discussion around contributing anonymously to risk personal attack and all that stuff.
...
Sjors Provoost: But do you remember the thing that we just talked about, but like the work being quite hard and you very occasionally meeting other people?
Now you're removing that part too because you're not.

Rodolfo Novak: Yeah, but you know, safety, right?
...
Mike Schmidt: Yeah, Z-Man's doing it, right?
He's got funding.
...
Rodolfo Novak: But you know, like guys, it's also not that like I think like the fear is blown a little bit out of proportion because, you know, a few devs had issues with Craig Wright and stuff.
...
Sjors Provoost: Kind of depends on where you live, too, right?
...
You know, subscribe to Sjors podcast, you know, follow James in multiple places.
Yeah.
So any final thoughts, James?

James O'Beirne: Thanks for throwing a great podcast.
I always love coming on and talking to you.

Rodolfo Novak: Hey, man, I really appreciate it.
You guys are awesome.
Sjors.

Sjors Provoost: Thanks for having me.
And yeah, please check out Bitcoin Explained.

Rodolfo Novak: And buy his book.
Mike.

Mike Schmidt: Yeah, I think it's easy to listen to two and a half hours of people talk about how strange everything is and BIPs here and that and activation and fighting and mailing lists and to be discouraged by that.
...
James O'Beirne: It's a really good point.
...
Don't forget to follow at Bitcoin Review HQ or get in touch on Telegram, Bitcoin Review Pod or Bitcoin Review at CoinKite.com.
...
Now, if you send us streaming sats, some of that go to opensats.org and also to Citadel Dispatch with my guest Odell.
If you don't know much about Value for Value or Bitcoin Podcast 2.0, Go to bitcoin.review.com
