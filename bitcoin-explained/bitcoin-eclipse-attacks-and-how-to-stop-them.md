...
So the paper runs a simulation to see how difficult it is to actually overflow all these buckets right?
...
The node still has connections, still has outbound connections to the real world so the question is, how can you get rid of those connections? 
...
Yeah.
And you may ask yourself why wouldn't you do that, right?
...
But there is an incentive for Bitcoin blocks to be broadcast in general, over satellite or AM, or for multiple sources so it's more difficult to eclipse someone because you'd have to eclipse the whole planet, right? 
...
So if you have multiple nodes that you're using for your, whatever your services and you make sure that the outside world doesn't know all of them, and they might try to eclipse one of them, but they forgot to eclipse the other ones.
