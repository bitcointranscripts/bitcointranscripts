...
And we're sort of like looking at each other like, no, I don't think he is like, wait cause it got the feeling that can you give us a better idea of the date, before Bitcoin Classic.
...
It's kind of annoying It's not actually that useful but part of I remember at the Australia meetup I think 2018.
I was like guys guys.
We really needed to get rid of millisats.
Let's just use satoshis This is gonna start being a big deal.
...
And so I think that SIGHASH AnyPrevout can help with something like that, but also something like coin pools or something, you know, OP_TAPLEAF_UPDATE_VERIFY, things like that where you're saying, okay, the outputs are sort of trees.
We started to have that with taproot, where now you have like this sort of tree, but something like that is definitely something, you know, I'm looking at and interested in, it's like, okay, We might only have a couple more years where we can feasibly get something in and so try to get something That will let people sort of share Yeah, I think AnyPrevout is also yeah, but I'm I think Channel that can serve anyone would be and the other the main other like not even fork wish list I just want it to be more usable because so many people, you know, quote unquote have Bitcoin and it's just on an exchange.
