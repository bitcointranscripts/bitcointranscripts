...
In the last conclusion of the lightning paper, he talks about 130 megabyte blocks.
...
I think we shouldn't be dogmatic in that, if it's a sort of religious, like Bitcoin only has 21 million Bitcoins and Bitcoin has one well really four megabyte blocks like this is dogmatic it's what are we trying to achieve is this, the best way to achieve it and and I think 

Murch: 00:01:22

programmable money, right?

Tadge Dryja: 00:01:26
You can program it.
Yeah and the thing I the distinction I make that sort of got lost, you know, five, six, seven years ago when everyone was arguing, I think there's sort of a economic reason for the block size and also a technical reason.
And I feel that the technical one is much more variable.
...
We want people to be able to take their old laptop, whatever computer, run a node, verify everything, like have that security that Bitcoin and Bitcoin Core and whatever gives you, and that's awesome.
And we need that.
...
And quickly, exponential! That's how exponential works.
Yeah, pretty soon.

Murch: 00:04:41

Yeah, and what is it?
We just went past the halfway point of this block subsidy era.
...
No, I'm not going to.
But I do think it's like people should talk about, like AJ Towns, you know, like talks about, okay, mining rewards and like how this should incentivize, you know, late.
...
It's an interesting paper as interesting attacks.
It kind of doesn't get to the heart of it because they assume unlimited block size and like the beginning of the paper They're like, okay assuming there's no limit.
...
So this was, I worked with Joseph, Joseph Poon in San Francisco, we met up at like SF Bitcoin devs and that's where everyone met everyone, and we talked, it was a lot of the, the HTLC part channels was his idea and we sort of talked about it and came up with all this stuff.
...
And we're sort of like looking at each other like, no, I don't think he is like, wait

Murch: 00:14:21

can you give us a better idea of the date, before Bitcoin Classic.

Tadge Dryja: 00:14:24
...
I mean, he said on video, Oh, I'll throw around my weight and make it happen

Tadge Dryja: 00:14:52

Yeah, that's not something that Wladimir has ever said or fanquake has ever said right like that's not how the current people who maintain Bitcoin Core think about it But I think Gavin you know he said hey, I was Satoshi made it I've been maintaining it like he wanted to you know made it could do what he wanted And I don't think he realized the mess that it was going to become.
...
That was sort of like during the process and coming up with Lightning Network.
...
A lot of it is, we can be all rational and Spock, Vulcan, whatever, But a lot of it is just like emotions, right?
...
It's not actually that useful but part of I remember at the Australia meetup I think 2018.
I was like guys guys.
We really needed to get rid of millisats.
Let's just use satoshis.
This is gonna start being a big deal.
It's gonna be hard to change.
So let's just change it now and you know Rusty and everyone's like nah, it's too late.
...
And so the solution in the current BOLT specs that you know LND LDK all these people use is and I'm working on two Now is you sort of pretend?
...
What if the people that do inscriptions are getting really really popular and fee rates go to 20 sats per vbyte in general and suddenly the dust size is effectively 20 times larger.
...
It would just say, that's not supported.
...
I think Joseph was like super into this like okay.
How do we make maybe there can be some other soft work where there's like block signaling and certain.
You know once the blocks are certain amount full these transactions can get priority and these others can't or something.
I don't but it's not even that it's just the the foresight that you would need to know what to pay in the future for fees.
Well that seems like RBF the justice transactions because those those are immediately spendable.
You have the immediate unencumbered key for and you and you in theory.
You know depending on your reserves in this channel you may have quite a bit to spend on fees before it actually eats into the money that like should be yours.
Right so if it's you know you're supposed to have five five and they close at six four and they shouldn't.
And you know you're supposed to get five coins, but they made it so that you get four coins, and you're taking the whole six output.
You really only need one of those coins to be made like whole.
And so you can spend like a bunch on fee, and you do have the ability to RBF it.
...
And you sort of get you can come up with different answers.
Like oh, yeah this much on you know on your regular UTXO wallet.
This much in channels if you closed immediately.
Uncooperatively you'd have this much, but then you'd get this much back later.
...
OK, so yeah, So Eltoo, I think, constructions like that, if Eltoo is still, you've got Alice and Bob in an Eltoo channel, and the only advantage is, hey, now we can not have this punishment transaction and sort of update.
...
And SegWit's better because there's a lot of foot guns with SIGHASH_ANYPREVOUT, no input.
...
And so, and I, after Taproot merged in, I was like, ooh, maybe we can have like a bunch of changes to Bitcoin in the next couple of years because, you know, before SegWit like OP_CSV and CSV, it was just like no big deal.
...
Although there exactly he James mentioned randomly yeah maybe we could use OP_VAULT as a covenant.
...
## What’s your wish list (hardfork wishlist wiki, softfork wishlist wiki) for protocol changes?
...
I know, okay, Gleb has the like op, not op code, it's like pools, the CoinPool.
...
And so I think that SIGHASH_ANYPREVOUT can help with something like that, but also something like coin pools or something, you know, OP_TAPLEAF_UPDATE_VERIFY, things like that where you're saying, okay, the outputs are sort of trees.
We started to have that with taproot, where now you have like this sort of tree, but something like that is definitely something, you know, I'm looking at and interested in, it's like, okay, We might only have a couple more years where we can feasibly get something in and so try to get something That will let people sort of share.
SIGHASH_ANYPREVOUT is also, yeah, but the main other like not even fork wish list I just want it to be more usable because so many people, you know, quote unquote have Bitcoin and it's just on an exchange.
...
Yeah, so I think, but I think that's part of, you know, part of it is writing code, getting these things working, and then part of it is also educating.
And getting people to understand it and use it and it is a sort of weird you know use it quote-unquote the right way because there's a definite like developers of Bitcoin Core and Bitcoin things are sort of like, hey guys, everyone do it this way.
...
That was Jim Posen.
gmaxwell came up, Gavin of course.
...
Like in some examples, it's like you're getting sued by some crazy guy in London.
Right, or or I don't really know what Greg Maxwell like he's been sort of off.
I mean, he's sort of still around he's like on reddit and stuff, you know.
But he's sort of okay I'm not working on this technically.
But yeah a lot of I think a lot of it is stories, a lot of it is like knowing people.
...
It's so much easier to like hang out with the people you know and talk to the people you know and If Pieter Wuille is putting a PR, you look at it and you read his post because like, oh, like I'm going to click on his post and read it because he's got so many good ideas.
...
In the Bitcoin companies. 
There is quite a few people that aren't there, it's a software job.
