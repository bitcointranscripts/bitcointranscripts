...
transcript_by: jfernandezr2807 via review.btctranscripts.com
media: https://www.youtube.com/watch?v=XDCQI7hrB58
tags: ["privacy"]
speakers: ["Felix Maurer","Aviv Zohar"]
...
I'm just going to run through this slide and then hopefully Aviv will jump in to clarify questions as they come or if I make a mistake.
So yeah, this is the

## Anonymous Coin Join Transactions with Arbitrary Values (2017)

paper, Anonymous Coin Trade Transaction with Arbitrary Values.
...
If we look at the work done in this paper, what they've done is they've formalized some basic ideas.
...
I just want to say for some administration that since Aviv appeared in this conversation, welcome Aviv, he is one of the authors of the paper and I think after your presentation we could move on to pick his brain and in order to not waste his time too much and then after that we can move on to other people's presentations and ideas and discussions about that.

Aviv: 00:05:48

Yeah so this is pretty much almost over I think we're probably two thirds of the way through so we'll be able to ask Aviv questions directly.
So yeah now moving on to

## In simpler terms

results so yeah in simpler terms we want to be able to break down transactions into sub-transactions, a combination of inputs and outputs.
...
they essentially create a bunch of random transactions and then essentially purposefully combine them together, and then observe the time it takes to recreate the sub-transactions from the coupled transactions.
...
be, everybody just needs to know all the inputs.
Okay, so interesting.
...
I was thinking that if Aviv appears, then we would start with some questions to Aviv and then we would continue with the, if anyone has some small presentations then we would continue with those and then we would end up with discussions, questions, what did we not understood in the paper.
Although this could be bring here right now because Aviv is still here.
...
So that was all my questions that only Aviv could answer.
Anyone has any questions to Aviv?
...
So do you have, Aviv, any idea how to handle this?
What can we do?
Any idea?
...
This is actually the question I wanted to ask Aviv was, you know, if he knows anything about how Wasabi currently works and, you know, the distinction between a coin join for mixing and a coin join for sending.
...
Yeah, back to the, for example, the idea that I said before that Aviv actually estimated the lower bound for the subset sum analysis here.
...
There are some papers that were cited by Aviv's paper that I thought were interesting but I think coin shuffle was one of them.
...
Yeah, I was kind of afraid that Aviv is going to leave.
We have to grab Aviv at the beginning because he's gonna leave.
Yeah, definitely.

Speaker 3: 01:26:29

Yes, From my point of view, the participation of Aviv was great.
So, for Sneakers, if we can have Adam here, it could be great too.

Speaker 1: 01:26:50

I will ask him I can't I can't promise Aviv didn't promise it to either he said he will try So that's why I didn't even send out a tweet or anything.
Hey, Aviv is going to be here because if he's not...
...
And also knowing that he's not working anymore, like Aviv is not working anymore, for example, on this topic is also valuable because you kind of understand where it goes and what questions he can cover and which questions probably should be covered by someone else.
So yeah, having an author of paper is very good here.
And of course the discussion afterwards, as always, just marvelous.

Speaker 1: 01:28:14

All right guys, so if no one has anything, then thank you all for coming and if this is published and you are listening it on YouTube or something, then definitely everything that we talked about, the paper, Aviv's code, our code, everything is going to be in the description.
