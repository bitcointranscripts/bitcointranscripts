...
So you could imagine that, let's say, Claire's been up and running for a year now, and I come online, and I don't want to start from the beginning, and therefore I borrow her graph, or I use a lightning service provider who's bootstrapping a new node, borrows a graph from another place.
...
Ha! Fun here! Fun! Fun! Fun! Fun! Fun here!
