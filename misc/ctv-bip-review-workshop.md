...
# Modify script_tests.json to enable OP\_NOP4
...
Q: If we get any form of ANYPREVOUT or SIGHASH_NOINPUT, you can emulate OP\_CHECKTEMPLATEVERIFY by putting a bare CHECKSIG in the redeemScript.
...
Q: If you have SIGHASH_NOINPUT, you can't prevent that. So saying that OP\_CHECKTEMPLATEVERIFY is made better by this...
