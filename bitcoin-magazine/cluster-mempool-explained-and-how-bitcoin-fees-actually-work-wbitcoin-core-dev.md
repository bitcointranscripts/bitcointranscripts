...
Hello, everybody.
I'm Shinobi, technical editor at Bitcoin Magazine, joined by Pieter Wuille of Chaincode Labs.
So we are here to discuss your latest obsession over the last few years, Cluster Mempool.

**Pieter Wuille:** 00:00:34
...
So you and Suhas daftaur kind of conceptualized this, I think, three years ago now, roughly?

**Pieter Wuille:** 00:01:16
...
And in fact, I think this was inspired by a talk Suhas gave to us here internally, just talking about the problems the Mempool has.
...
There's a BIP 125 rules which are so sort of followed still, but they are heuristics and they are imperfect in many ways.
...
So it's not like the nodes aren't being compensated but they're still bearing the cost.

**Pieter Wuille:** 00:10:38

Right.
Ideally we'd have the transaction relayers receive the income for relaying transactions.

**Shinobi:** 00:10:50

If you figure that out let me know we can finally replace Bitcoin.

**Pieter Wuille:** 00:10:55
...
The ordering is like you first mine this, then this.
Now you add one very high fee rate transaction to the end and suddenly it's this.
...
Yeah, and of course, once we had that, there's an obvious follow-up question because as I mentioned earlier, the existing logic for deciding transactions at block building time is suboptimal in many ways.
...
**Pieter Wuille:** 00:23:22

You can come up with whatever use case and the algorithm or the behavior of nodes just becomes well, if it's better I'll take it, if it's not better I won't take it and it can discern betterness in any topology of up to 64 transactions.
...
But how that's decided, that's sort of a very high level black box kind of thing where before we had the BIP 125 rules which were not perfect and deviated from in several ways, but they gave you a list of conditions like, if you satisfy the rules the replacement will go through.
